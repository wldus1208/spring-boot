...
<DIV>
	...
	<form name='viewForm' method='POST' action='./update.do'>
		<table style='width: 30%; text-align:center;'>
        	...
        	<tr>
        		<th>제목: </th>
        		<td><input name="notice_title" type="text" value="${noticeVO.notice_title }"></td>
        	</tr>
        	<tr>
        		<th>공지 내용: </th>
        		<td><textarea name="notice_content" style="height:200px;">${noticeVO.notice_content }</textarea></td>
        	</tr>
		</table>
